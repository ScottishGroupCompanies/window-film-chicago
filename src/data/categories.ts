...
export const benefitCategories: Category[] = [
  {
    ...
    description: 'Window film that reduces heat gain and cooling costs for Chicago homes and businesses.',
  ...
  },
  {
    ...
    href: '/benefits/privacy-window-film-chicago/',
    group: 'benefit',
  },
  {
...
export const applicationCategories: Category[] = [
  {
    slug: 'homes-condos',
    label: 'Homes & Condos',
    description: 'Window film solutions for Chicago-area homes, condos, two-flats, and bungalows.',
  ...
  },
  {
    ...
    description: 'Window film for Chicago office buildings — privacy, glare control, and energy savings.',
  ...
  },
  {
    slug: 'retail',
    label: 'Retail',
    description: 'Storefront window film for Chicago retail — branding, glare reduction, and customer comfort.',
  ...
  },
  {
    slug: 'restaurants',
    label: 'Restaurants',
    description: 'Window film for Chicago restaurants — glare reduction, UV protection, and ambiance.',
  ...
  },
  {
    ...
    description: 'Window film for Chicago hotels and hospitality venues — guest comfort and energy efficiency.',
  ...
  },
  {
    ...
    description: 'Window film for transit hubs, airports, and transportation facilities in Chicago.',
  ...
  },
  {
    ...
    description: 'Window film for Chicago schools and universities — safety, security, and UV protection.',
  ...
  },
  {
    ...
    description: 'Window film for Chicago healthcare facilities — patient privacy and UV protection.',
  ...
  },
  {
    ...
    description: 'Security and blast-mitigation window film for Chicago government and municipal buildings.',
  ...
  },
  {
    ...
    description: 'High-security window film for Chicago facilities requiring forced-entry and blast resistance.',
  ...
  },
  {
    ...
    description: 'UV-blocking window film for Chicago museums, archives, and libraries.',
  ...
  },
  {
    ...
    description: 'Window film for Chicago churches and faith centers — stained glass, security, and energy savings.',
...
export const cityCategories: Category[] = [
  {
    slug: 'chicago',
    label: 'Chicago',
    description: 'Window film tips, guides, and local insights for Chicago homeowners and businesses.',
    href: '/cities/chicago/',
    group: 'city',
  },
];
